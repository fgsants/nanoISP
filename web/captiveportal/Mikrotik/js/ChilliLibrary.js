...
if (!chilliController || !chilliController.host) { var chilliController = { interval: 30, host: '10.0.0.253', port: 3990, ident: '00', ssl: false, uamService: false } }
...
chilliController.formatTime = function (t, zeroReturn) {
  ...
  if (t < 60) { return s_str + 's' } else if (t < 3600) { return m_str + 'm' + s_str + 's' } else { return h_str + 'h' + m_str + 'm' + s_str + 's' }
}
